...
if( _.FileRecord )
{
  ...
  var f1 = wFileRecord({ dir : _.pathBaseDir(), pathFile : '../staging/dwtools/amid/files/Uses.ss' });
  var f2 = wFileRecord({ dir : _.pathBaseDir(), pathFile : '../proto/amid/files/Uses.ss' });
