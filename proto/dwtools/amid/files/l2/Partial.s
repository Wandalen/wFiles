...
function statRead_body( o )
{
  ...
  return self.statReadAct( o2 );
}

_.routineExtend( statRead_body, statReadAct );

statRead_body.defaults.resolvingTextLink = null;
...
function _link_functor( gen )
{
  ...
  function _link_body( o )
  {
    ...
    if( o.dstPath === o.srcPath )
    {
      ...
      if( !self.statResolvedRead({ filePath : o.srcPath, resolvingSoftLink : 0, resolvingTextLink : 0 }) )
      {
    ...
    */
    ...
    else /* async */
    {
      ...
      con.ifNoErrorThen( () => self.statResolvedRead( statOptions ) );
...
function fileCopy_functor()
{
  ...
  function _onBeforeRaname( o )
  {
    ...
    let isDir = self.resolvedIsDir({ filePath : o.srcPath, resolvingSoftLink : 0, resolvingTextLink : 0 })
    if( isDir )
    {
      debugger;
